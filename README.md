...
* Percentage of searching the state space[^1]: 0.30864%
* Shortest found route: 709.5766
* Improving the quality of the solution by 35.0135% comparing the best and worst individual from all generated populations.
...
* Improving the quality of the solution by 51.9150% comparing the best and worst individual from all generated populations.
...
* Improving the quality of the solution by 64.5187% comparing the best and worst individual from all generated populations.
...
[^1]: Percentage of the state space searched means the ratio of the number of all generated solutions to all potential solutions, i.e., the factorial from the number of cities. It is worth mentioning that the solutions generated by the algorithm can be repeated.
